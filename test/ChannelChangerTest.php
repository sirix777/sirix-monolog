...
class ChannelChangerTest extends TestCase
{
    ...
    private HandlerManager|MockObject $mockHandlerManager;
    private MockObject|ProcessorManager $mockProcessorManager;
    private ChannelConfig|MockObject $mockChannelConfig;
    private MockObject|StreamHandler $mockHandler;
    private MockObject|PsrLogMessageProcessor $mockProcessor;
